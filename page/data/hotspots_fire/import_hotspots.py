...
def save_csv(hotspot_fire):
    ...
    csv_f.writerow([hotspot_fire.date.strftime("%Y-%m-%d %H:%M"), hotspot_fire.geom.y, hotspot_fire.geom.x, hotspot_fire.source])
    ...
    for line in reader:
        ...
        if colombia.mpoly.contains(pnt_hotspot):
            ...
            if hotspot_count == 0:
                ...
                hotspot_fire = HotspotFire(date=hotspot_datetime, source=source, brightness=brightness, geom=Point(lng, lat))
